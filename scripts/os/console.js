    ...
    this.handleInput = function() {
       while (_KernelInputQueue.getSize() > 0)
       {
           ...
           if (chr == String.fromCharCode(13))  //     Enter key
           {
               ...
               _Commands.push(this.buffer);
               _CommandPlace = _Commands.length;
           ...
           else if(chr == String.fromCharCode(8))
           {
               if(!(this.buffer === ""))
               {
                   _DrawingContext.clearRect(0, this.CurrentYPosition-14, _Canvas.width, 19);
           ...
           else if(chr == String.fromCharCode(11))
           {
               ...
               {
                   _CommandPlace--;
                   this.buffer = _Commands[_CommandPlace].toString();
                   _DrawingContext.clearRect(0, this.CurrentYPosition-14, _Canvas.width, 19);
                   this.CurrentXPosition = 0;
                   this.putText(_OsShell.promptStr + this.buffer);
               }
           ...
           //down arrow
           else if(chr == String.fromCharCode(12))
           {
               if(_CommandPlace < _Commands.length-1)
               {
                   _CommandPlace++;
                   this.buffer = _Commands[_CommandPlace].toString();
                   _DrawingContext.clearRect(0, this.CurrentYPosition-14, _Canvas.width, 19);
